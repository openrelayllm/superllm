...
ALTER TABLE admin_plus_action_recommendations
    ...
    CHECK (type IN ('switch_supplier', 'pause_supplier', 'degrade_supplier', 'increase_weight', 'recharge_supplier', 'investigate_profit', 'review_credential', 'routing_refill'));
...
ALTER TABLE admin_plus_action_executions
    ...
    CHECK (action_type IN ('switch_supplier', 'pause_supplier', 'degrade_supplier', 'increase_weight', 'recharge_supplier', 'investigate_profit', 'review_credential', 'routing_refill'));
