...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	costHandler := adminplus.NewCostHandlerWithProvisionJobsSchedulerAndActions(costsService, provisionjobsService, schedulerService, actionsService)
	...
	sub2APIHandler := adminplus.NewSub2APIHandlerWithAccountTestAndActions(sub2apiService, accountTestService, actionsService)
