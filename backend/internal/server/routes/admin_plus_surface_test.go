...
func newAdminPlusSurfaceRouter() *gin.Engine {
	...
	schedulerService := schedulerapp.NewService(supplierService, extensionService)
...
func TestAdminPlusCurrentRoutesAreMounted(t *testing.T) {
	...
	currentRoutes := []string{
		...
		"POST /api/v1/admin-plus/account-rate-sync/accounts/:accountID/retry",
		"POST /api/v1/admin-plus/account-rate-sync/history/:historyID/rename",
		"DELETE /api/v1/admin-plus/account-rate-sync/history",
		...
		"GET /api/v1/admin-plus/scheduler/center/status",
		...
		"DELETE /api/v1/admin-plus/scheduler/runs",
		"GET /api/v1/admin-plus/scheduler/runs/:id",
		"DELETE /api/v1/admin-plus/scheduler/runs/:id",
		...
		"PATCH /api/v1/admin-plus/scheduler/actions/:id/status",
		"GET /api/v1/admin-plus/scheduler/settings",
		"PUT /api/v1/admin-plus/scheduler/settings",
