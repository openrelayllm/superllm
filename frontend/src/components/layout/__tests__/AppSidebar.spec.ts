...
describe('AppSidebar SuperLLM navigation', () => {
  it('只展示 SuperLLM current 导航入口', () => {
    ...
    expect(componentSource).not.toContain("path: '/admin/backup'")
    expect(componentSource).not.toContain("path: '/admin/import-export'")
    ...
    expect(componentSource).not.toContain("path: '/admin/kanban'")
    expect(componentSource).not.toContain("path: '/admin/proxy'")
    expect(componentSource).not.toContain("path: '/admin/mails'")
    expect(componentSource).not.toContain("path: '/admin/site-catalog'")
    expect(componentSource).not.toContain("path: '/admin/server-renewal'")
  ...
  it('将业务页面收敛到当前导航分组下', () => {
    ...
    expect(schedulerGroupMatch?.[1]).not.toContain("label: '数据备份'")
    expect(schedulerGroupMatch?.[1]).not.toContain("label: '导入/导出'")
    expect(componentSource).not.toContain("label: '运营看板'")
