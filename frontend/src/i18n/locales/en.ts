  ...
  keys: {
    ...
    useKeyModal: {
      ...
      gemini: {
        ...
        modelComment: 'For Gemini tests, prefer the official or compatible models available on the current account.',
        note: 'These environment variables will be active in the current terminal session. For permanent configuration, add them to ~/.bashrc, ~/.zshrc, or the appropriate configuration file.',
      },
      opencode: {
  ...
  admin: {
    ...
    settings: {
      ...
      user_error_view: {
        ...
        description: 'When enabled, users can see a redacted view of their failed requests on the usage page (no internal/upstream details). Data is available only after request logs are written.',
      },
    ...
    errorPassthrough: {
      ...
      form: {
        ...
        skipMonitoring: 'Skip monitoring',
        skipMonitoringHint: 'When enabled, errors matching this rule will not be written to monitoring records',
