export default {
  ...
  admin: {
    ...
    settings: {
      ...
      user_error_view: {
        label: '允许用户查看自己的错误请求',
        description: '开启后，用户可在用量页查看自己失败请求的精简信息（不含内部/上游错误细节）。仅在请求日志已写入时有数据。',
      },
      saveSettings: '保存设置',
      saving: '保存中...',
    ...
    errorPassthrough: {
      ...
      form: {
        ...
        skipMonitoring: '跳过监控记录',
        skipMonitoringHint: '开启后，匹配此规则的错误不会写入监控记录',
        enabled: '启用此规则'
      },
  ...
  version: {
    ...
    containerModeHint: '容器部署请拉取新镜像后重启 Compose 或平台服务',
    updateNow: '立即更新',
    updating: '正在更新...',
    updateComplete: '更新完成',
    updateFailed: '更新失败',
